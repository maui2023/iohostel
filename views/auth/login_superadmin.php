...
<head>
    ...
    <title>Superadmin Login - <?php echo $_ENV['HOSTEL_NAME'] ?? 'Hostel System'; ?></title>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo $_ENV['BASE_URL']; ?>/assets/css/style.css" rel="stylesheet">
    ...
    <div class="login-wrapper">
        <div class="login-card">
            <div class="login-header">
                ...
                <h2 class="fw-bold mb-2">Superadmin Portal</h2>
                ...
                <form method="POST" action="" id="loginForm" novalidate>
                    ...
                    <div class="form-floating">
                        ...
                        <label for="email_or_phone">
                            <i class="bi bi-person-circle me-2"></i>Email or Phone Number
                        </label>
