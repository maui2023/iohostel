...
if (isAuthenticated() && hasRole('parent')) {
    header('Location: ' . $_ENV['BASE_URL'] . '?page=parent-dashboard');
    exit;
}
...
<head>
    ...
    <title>Parent Login - <?php echo $_ENV['HOSTEL_NAME'] ?? 'Hostel Management System'; ?></title>
    ...
    <style>
        :root {
            ...
            --parent-gradient: linear-gradient(135deg, #6f42c1 0%, #e83e8c 100%);
        }
    ...
    <div class="login-wrapper">
        <div class="login-card">
            <div class="login-header">
                ...
                <h2 class="fw-bold mb-2">Parent Portal</h2>
